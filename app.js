   ...
   function menu(){
    console.log(`
        ...
        let opcao = prompt('digite sua opcao desejada:');

        switch(opcao){
            case '1':
                let titulo = prompt(' Informe o titulo:');
                criarBaralho({ titulo });
                console.log('Baralho adiconado com sucesso!');
                menu();
                break;
            case '2':
                listarBaralhos();
            ...
            case '5':
                ...
                idBaralho = prompt('Qual é o ID do baralho que será adiconado o flashcard? ');
            ...
            case '7':
                listarBaralhos();
                let idBara = parseInt(prompt("Informe o ID do baralho para listar os flashcards"));
